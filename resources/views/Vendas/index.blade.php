...
<body>
  ...
  <div class="container-fluid">    
    ...
    @foreach($vendas as $dados)       
        <div class="col-sm-3">
          <div class="card text-center" style="width: 20rem; background: linear-gradient(180deg, #ff0000 10%, #f1af09 100%);">
            <img src="{{ asset('img/produtos/' . $dados["imagem"]) }}" class="card-img-top" alt="..." id="imagem">
            <div class="card-body">
              <h5 class="card-title" style="color: white">{{$dados["nome"]}}</h5>              
