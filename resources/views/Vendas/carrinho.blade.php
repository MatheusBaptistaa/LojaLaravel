...
<nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark" style="background: linear-gradient(180deg, #f1af09 10%, #ff0000 100%);">
  <div class="container-fluid">    
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      ...
      <span class="navbar-text">
        <a class="btn btn-outline-light" href="/vendas/exibir-carrinho">🛒</a>
      </span>
    </div>
  </div>
</nav>
            ...
            <div class="row">
                <div class="col-10">
                    <table class="table caption-top">
                        <caption>
                            <h1 class="title_carrinho" style="color: white; text-align:center">Carrinho de Compras</h1>
                        </caption>
                        <thead>
    ...
    <tr style="color: white">
        ...
        <td>{{ $produto['nome'] }}</td>
        <td>
            <a href="/vendas/carrinho/remover/{{$produto['id']}}" style="text-decoration:none" >➖</a>
            {{ $produto['quantidade'] }}
            <a href="/vendas/carrinho/{{$produto['id']}}" style="text-decoration:none" >➕</a>
        </td>
        <td>R$ {{ $produto['preco'] }}</td>
        <td>R$ {{ $total = $produto['preco'] * $produto['quantidade'] }}</td>
        <td><a href="/vendas/carrinho/excluir/{{$produto['id']}}" style="text-decoration:none" >🗑️</a></td>
    </tr>
    <?php
...
@endforeach
    ...
    <div id="finalizarCompra">
        <form action="/vendas/finalizar-compra" method="post">
            @csrf   
            <div class="mb-3">
                <label for="email" class="form-label" id="labelEmail" style="color: white">E-mail</label>
            ...
            <button type="submit" class="btn btn-success btn-lg">Finalizar Compra</button>
                ...
                <!--<div class="col-2">
                    <caption>
                        <h1 class="title_resumo" style="color: white">Resumo</h1>
                    </caption>
